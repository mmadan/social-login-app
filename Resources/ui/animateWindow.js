...
{
	Ti.include("/linkedin/linkedin_client.js");
	var client = new linkedin_client();
	...
	{
		Ti.App.Properties.setString("linkedin_token", client.get_oauth_token());
		Ti.App.Properties.setString("linkedin_token_secret", client.get_oauth_token_secret());
		Ti.App.Properties.setString("linkedin_pin",client.get_pin());
		complete();
		win.close();
	}
	var login_linkedin = function() 
	{
